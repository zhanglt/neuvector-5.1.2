...
check_3_1_2="3.1.2  - Service account token authentication should not be used for users (Manual)"
info "$check_3_1_2"
info "        * Review user access to the cluster and ensure that users are not making use of service account token authentication."

check_3_1_3="3.1.3  - Bootstrap token authentication should not be used for users (Manual)"
info "$check_3_1_3"
info "        * Review user access to the cluster and ensure that users are not making use of bootstrap token authentication."
